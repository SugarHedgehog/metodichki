...
%    \begin{enumerate}
%        \item проходит через все заданные $N$ точек $(x_k, y_k),$ $k=1, 2, \dots, N$
%        \item на каждом отрезке между соседними точками является кубическим полиномом
%        \item непрерывна вместе со своими первой и второй производными во всех точках
%    \end{enumerate}
%\end{frame} 
