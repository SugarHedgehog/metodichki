...
\end{tabular}\\
	\begin{tabular}{|*{4}{p{3.222cm}|}}
		...
		1.р-целое число - $x=z^{N}, N$-общий знаменатель m и n.
...
\begin{tabular}{||p{16.7cm}||}
	...
	$\int P(x)\cos{ax}dx=\cfrac{\sin{ax}}{a}(P(x)-\cfrac{P"(x)}{a^2}+\cfrac{P^{\romannumeral 4}(x)}{a^4}-\dots)+\cfrac{\cos{ax}}{a^2}(P'(x)-\cfrac{P^{\romannumeral 3}(x)}{a^2}+\cfrac{P^{\romannumeral 5 3}(x)}{a^2})$
	
	$\int P(x)\sin{ax}dx=\cfrac{-\cos{ax}}{a}(P(x)-\cfrac{P"(x)}{a^2}+\cfrac{P^{\romannumeral 4}(x)}{a^4}-\dots)+\cfrac{\cos{ax}}{a^2}(P'(x)-\cfrac{P^{\romannumeral 3}(x)}{a^2}+\cfrac{P^{\romannumeral 5 3}(x)}{a^2})$\\
	\hline
\end{tabular} 
