...
\usepackage{etoolbox,fontspec,polyglossia,pdflscape,enumitem,amsfonts,amssymb,amsthm,mathtools,amsmath,icomma,euscript,mathrsfs,graphicx,wrapfig,array,tabularx,tabulary,booktabs,longtable,multirow,multicol,tikz,pdfpages,xcolor}
...
\setlist{noitemsep,topsep=0pt,parsep=0pt,partopsep=0pt,leftmargin=0.1em}
...
\usepackage[a5paper,left=1cm,right=1cm,top=0.8cm,bottom=0.8cm,columnsep=0.8cm,headsep=0.2cm]{geometry}
...
% Define a barely visible color
\definecolor{barelyvisible}{gray}{0.6}

\begin{document}

% Установить серый цвет для всего текста
\color{barelyvisible}
